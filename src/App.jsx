...
import mainLogo from './assets/Amazon_logo.svg'
import './App.css';
...
const App = () => {
  const [products] = useState([
    ...
    {
      id: 2,
      name: 'OnePlus Nord CE4 Lite 5G (8GB RAM, 128GB Storage)',
      price: 19999,
      oldPrice: '₹20,999',
    ...
    },
    {
      ...
      price: 33300,
      oldPrice: '₹50,990',
      description: 'Corning Gorilla Glass Victus+ | Vapour Cooling Chamber | 6000mAh Battery | 120Hz Super AMOLED Display',
      rating: 3.5,
    ...
    },
    {
      ...
      price: 32900,
      description: 'with A14 Bionic chip, 27.69 cm (10.9″) Liquid Retina display, 64GB, Wi-Fi 6, 12MP front/12MP back camera',
  ...
  return (
    <div className="App">
      ...
      <header className="bg-dark text-white text-center py-5 position-relative">
        <h1>Amazon Great Indian Sale📢</h1>
        <p>Starts early for our Amazon Prime Customers... Big Savings for everyone!!!</p>
      </header>
      ...
      <header className="bg-dark text-white text-center py-5 position-relative">
        <span>Copyright @Amazon.com 2024. All rights reserved</span>
      </header>
